...
export const schema = new Schema({
  nodes: {
    ...
    ordered_list: {
      content: "(todo_list_item | list_item)+",
      group: "block",
    ...
    // Credits to: https://glitch.com/edit/#!/brass-hiss
    todo_list_item: {
      attrs: { 
        done: {default: false} 
      },
  ...
  marks: {
    del: {
      parseDOM: [
        {tag: "strikethrough"}, {tag: "del"},
        {style: "text-decoration=strikethrough", clearMark: m => m.type.name == "del"}
      ],
      toDOM() { return ["span", {
        class: "node-mark-del"
      }]}
